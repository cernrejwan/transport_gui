...
class ShapePage(BasePage):
    def __init__(self, parent, controller, **kwargs):
        ...
        Label(self.rect_frame, text="Set rectangule's coordinates:").grid(row=0, columnspan=4)
        Label(self.rect_frame, text="x1=").grid(row=1, column=0)
        Entry(self.rect_frame, textvariable=self.rect_x1).grid(row=1, column=1)
        Label(self.rect_frame, text="y1=").grid(row=1, column=2)
        Entry(self.rect_frame, textvariable=self.rect_y1).grid(row=1, column=3)
        Label(self.rect_frame, text="x2=").grid(row=2, column=0)
        Entry(self.rect_frame, textvariable=self.rect_x2).grid(row=2, column=1)
        Label(self.rect_frame, text="y2=").grid(row=2, column=2)
        Entry(self.rect_frame, textvariable=self.rect_y2).grid(row=2, column=3)
